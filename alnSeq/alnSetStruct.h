...
\--------------------------------------------------------*/
static inline void setBasePairScore(
...
|      the file (scoreFILE)
\--------------------------------------------------------*/
static inline unsigned long readInScoreFile(
    struct alnSet *alnSetST,// has scoring matrix to change
...
\--------------------------------------------------------*/
static inline void seqToLookupIndex(
...
|      table indexs
\--------------------------------------------------------*/
static inline void lookupIndexToSeq(
   char *seqStr /*Sequence to convert*/
){ /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\
